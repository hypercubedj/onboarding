...
return [
    ...
    | comme les règles de taille. N'hésite pas à personnaliser ces messages ici.
    |
    */
    ...
    | les attributs en utilisant la convention "attribut.règle" pour nommer les lignes.
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes de langue suivantes sont utilisées pour remplacer les espaces réservés
    | des attributs par quelque chose de plus convivial, comme "Adresse e-mail"
    | au lieu de "email". Cela nous aide simplement à rendre nos messages plus
    | expressifs.
    |
    */
