...
<template>
    <GuestLayout>
        <Head :title="t('auth.login_button')" /> <!-- Traduire le titre -->
        ...
        <form @submit.prevent="submit">
            <div>
                <InputLabel for="email" :value="t('auth.email')" /> <!-- Traduction de "Email" -->
            ...
            <div class="mt-4">
                <InputLabel for="password" :value="t('auth.password')" /> <!-- Traduction de "Password" -->
            ...
            <div class="mt-4 block">
                <label class="flex items-center">
                    ...
                    <span class="ms-2 text-sm text-gray-600">{{ t('auth.remember') }}</span> <!-- Traduction de "Remember me" -->
                </label>
            </div>
